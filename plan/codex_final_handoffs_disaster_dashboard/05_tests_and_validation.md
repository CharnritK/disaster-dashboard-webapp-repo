...
> Archive notice: this is a historical visualization-guardrails validation plan, not current project guidance. Use `README.md`, `AGENTS.md`, and current `package.json` scripts for active verification commands.
