...
> Archive notice: this is a historical implementation handoff package, not current setup documentation. It may describe work as future implementation even when the current app already includes related capabilities. Start with [../docs/README.md](../docs/README.md) for current project documentation.
