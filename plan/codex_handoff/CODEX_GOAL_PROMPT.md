...
> Archive notice: this is a historical handoff prompt, not current project guidance. Use `README.md`, `AGENTS.md`, and `docs/README.md` for current setup and product contract.
