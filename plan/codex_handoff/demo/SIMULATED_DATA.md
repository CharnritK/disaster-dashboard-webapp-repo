...
> Archive notice: this sample-data note belongs to the historical handoff package, not current project guidance. Use current `public/samples/`, `data/samples/`, and `README.md` sample guidance for active app behavior.
