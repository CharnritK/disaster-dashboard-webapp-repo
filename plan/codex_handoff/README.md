...
> Archive notice: this is a historical implementation handoff package, not current setup documentation. It may reference old branches, dates, or missing work that has since been implemented. Start with [../docs/README.md](../docs/README.md) for current project documentation.
