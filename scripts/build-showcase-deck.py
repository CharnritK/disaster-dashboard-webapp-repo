...
DEFAULT_IMAGE_DIR = Path(
    r"C:\Users\point\.codex\generated_images\019ebae2-6c07-7c71-a12e-b69fd6f3fc99"
)
DEFAULT_OUT = Path("artifacts/showcase-deck/disaster-response-dashboard-showcase.pptx")
